...
class FunctionTangentIntegrationTest {
    ...
    fun `Given only sinus module When computing function value at F(x) = 0 Then F(x) is correct`() {
        // 2 * (Math.PI * n - 1.31766)
        // 2 * (Math.PI * n - 0.1999472)
        // 2 * (Math.PI * n + 1.31522)
        assertEquals(2.669, f(2 * (Math.PI * 0.0 - 1.31766), epsilon), diff)
        assertEquals(2.669, f(2 * (Math.PI * -1.0 - 1.31766), epsilon), diff)
        assertEquals(0.006, f(2 * (Math.PI * 0.0 - 0.1999472), epsilon), diff)
        assertEquals(0.006, f(2 * (Math.PI * -1.0 - 0.1999472), epsilon), diff)
        assertEquals(0.436, f(2 * (Math.PI * -1.0 + 1.31522), epsilon), diff)
        assertEquals(0.436, f(2 * (Math.PI * -2.0 + 1.31522), epsilon), diff)
    }
}
