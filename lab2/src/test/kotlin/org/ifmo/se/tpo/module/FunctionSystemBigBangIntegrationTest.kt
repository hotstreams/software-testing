...
class FunctionSystemBigBangIntegrationTest {
    ...
    private val log2 = Log2Impl(ln)
    private val log10 = Log10Impl(ln)
    private val log5 = Log5Impl(ln)

    private val epsilon = 1e-6
    private val diff = 0.001
